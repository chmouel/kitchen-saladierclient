...
# under the License.
#
# Imported from ironiclient.client
...
def get_client(api_version, **kwargs):
    ...
    :param kwargs: keyword args containing credentials, either:
            ...
            * saladier_url: Saladier API endpoint
            or:
    ...
    if kwargs.get('os_auth_token') and kwargs.get('saladier_url'):
        token = kwargs.get('os_auth_token')
        endpoint = kwargs.get('saladier_url')
        auth_ref = None
        ...
        endpoint = (kwargs.get('saladier_url') or
                    _get_endpoint(_ksclient, **ks_kwargs))

        auth_ref = _ksclient.auth_ref

    else:
        e = 'Must provide Keystone credentials or user-defined endpoint '
        'and token'
