...
class SaladierShell(object):
    ...
    def get_base_parser(self):
        parser = argparse.ArgumentParser(
            ...
            epilog='See "saladier help COMMAND" '
        ...
        parser.add_argument('--version',
                            action='version',
                            version=saladierclient.__version__)

        parser.add_argument('--debug',
                            default=bool(cliutils.env('SALADIERCLIENT_DEBUG')),
                            action='store_true',
                            help='Defaults to env[SALADIERCLIENT_DEBUG]')
        ...
        parser.add_argument('--saladier-url',
                            default=cliutils.env('SALADIER_URL'),
                            help='Defaults to env[SALADIER_URL]')

        parser.add_argument('--saladier_url',
                            help=argparse.SUPPRESS)

        parser.add_argument('--saladier-api-version',
                            default=cliutils.env(
                                'SALADIER_API_VERSION', default='1'),
                            help='Defaults to env[SALADIER_API_VERSION] '
                            'or 1')

        parser.add_argument('--saladier_api_version',
                            help=argparse.SUPPRESS)
    ...
    def _get_keystone_v2_auth(self, v2_auth_url, **kwargs):
        ...
        if auth_token:
            ...
            return v2_auth.Password(v2_auth_url,
                                    ...
                                    tenant_id=kwargs.pop('project_id', None),
                                    tenant_name=kwargs.pop('project_name',
                                                           None))
    ...
    def main(self, argv):
        ...
        api_version = options.saladier_api_version
        ...
        if not (args.os_auth_token and args.saladier_url):
